            ...
            <div className="grid grid-cols-3 gap-4 mb-4">
              <div className="text-center">
                <div className="flex items-center justify-center space-x-2 mb-2">
                  ...
                  <span className="text-3xl font-bold">{routeData.totalDeliveries}</span>
                </div>
                <p className="text-base font-normal text-gray-500">Deliveries</p>
              </div>
              
              <div className="text-center">
                <div className="flex items-center justify-center space-x-2 mb-2">
                  <Icon name="MapPin" size={24} className="text-green-600" />
                  <span className="text-3xl font-bold">{routeData.totalDistance}</span>
                </div>
                <p className="text-base font-normal text-gray-500">Total Distance</p>
              </div>
              
              <div className="text-center">
                <div className="flex items-center justify-center space-x-2 mb-2">
                  <Icon name="Timer" size={24} className="text-purple-600" />
                  <span className="text-3xl font-bold">{routeData.estimatedTime}</span>
                </div>
                <p className="text-base font-normal text-gray-500">Est. Time</p>
              </div>
            </div>
