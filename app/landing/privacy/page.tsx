...
export default function LandingPrivacyPage() {
  ...
  return (
    <div id="parcego-landing-privacy-container" className="py-8 px-4 sm:px-6 lg:px-8">
      {/* Skip to main content link for keyboard navigation */}
      <a 
        href="#main-content" 
        className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:px-4 focus:py-2 focus:bg-blue-600 focus:text-white focus:rounded-md"
        id="parcego-landing-privacy-skip-link"
      >
      ...
      <main id="main-content" className="max-w-4xl mx-auto" role="main" aria-label="Privacy Policy">
          ...
          <Card>
            ...
            <CardContent>
              <ol className="space-y-2 list-decimal list-inside text-sm text-gray-700">
                <li><a href="#parcego-landing-privacy-collection" className="hover:text-blue-600 hover:underline focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 rounded">Information We Collect</a></li>
                <li><a href="#parcego-landing-privacy-use" className="hover:text-blue-600 hover:underline focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 rounded">How We Use Your Information</a></li>
                <li><a href="#parcego-landing-privacy-sharing" className="hover:text-blue-600 hover:underline focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 rounded">Information Sharing and Disclosure</a></li>
                <li><a href="#parcego-landing-privacy-security" className="hover:text-blue-600 hover:underline focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 rounded">Data Security</a></li>
                <li><a href="#parcego-landing-privacy-rights" className="hover:text-blue-600 hover:underline focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 rounded">Your Rights and Choices</a></li>
                <li><a href="#parcego-landing-privacy-cookies" className="hover:text-blue-600 hover:underline focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 rounded">Cookies and Tracking Technologies</a></li>
                <li><a href="#parcego-landing-privacy-transfers" className="hover:text-blue-600 hover:underline focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 rounded">International Data Transfers</a></li>
                <li><a href="#parcego-landing-privacy-children" className="hover:text-blue-600 hover:underline focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 rounded">Children's Privacy</a></li>
                <li><a href="#parcego-landing-privacy-changes" className="hover:text-blue-600 hover:underline focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 rounded">Changes to This Privacy Policy</a></li>
                <li><a href="#parcego-landing-privacy-contact" className="hover:text-blue-600 hover:underline focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 rounded">Contact Us</a></li>
              </ol>
            </CardContent>
          </Card>
        </nav>
        ...
        <Card id="parcego-landing-privacy-main-content" className="mb-8" role="article" aria-labelledby="privacy-overview-title">
          <CardHeader>
          ...
          <CardContent className="space-y-8">
            ...
            <section id="parcego-landing-privacy-collection" aria-labelledby="section-collection">
            ...
            <section id="parcego-landing-privacy-use" aria-labelledby="section-use">
            ...
            {/* Information Sharing */}
            <section id="parcego-landing-privacy-sharing" aria-labelledby="section-sharing">
            ...
            {/* Data Security */}
            <section id="parcego-landing-privacy-security" aria-labelledby="section-security">
            ...
            {/* Your Rights */}
            <section id="parcego-landing-privacy-rights" aria-labelledby="section-rights">
            ...
            <section id="parcego-landing-privacy-cookies" aria-labelledby="section-cookies">
            ...
            <section id="parcego-landing-privacy-transfers" aria-labelledby="section-transfers">
            ...
            {/* Children's Privacy */}
            <section id="parcego-landing-privacy-children" aria-labelledby="section-children">
            ...
            <section id="parcego-landing-privacy-changes" aria-labelledby="section-changes">
            ...
            {/* Contact Information */}
            <section id="parcego-landing-privacy-contact" aria-labelledby="section-contact">
        ...
        <nav aria-label="Related pages" className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
          <Button 
            ...
            id="parcego-landing-privacy-support-btn"
          ...
          <Button 
            ...
            className="flex items-center gap-2"
            id="parcego-landing-privacy-terms-btn"
