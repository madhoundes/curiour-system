...
# Parcego Courier Platform - Alternative HTTPS Development Server
# This script uses Next.js built-in HTTPS support instead of experimental flags

echo "🚀 Starting Parcego Courier Platform with Alternative HTTPS support..."
...
# Start the HTTPS development server using Next.js built-in HTTPS
echo "🔧 Starting HTTPS development server with built-in Next.js HTTPS..."
echo "📊 If you see a white screen, check the browser console for errors"
echo ""

# Use Next.js built-in HTTPS support
