...
export default function TermsConditionsPage() {
  ...
  return (
    <div id="parcego-terms-conditions-container" className="space-y-6">
      {/* Skip to main content link for keyboard navigation */}
      <a 
        href="#main-content" 
        className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:px-4 focus:py-2 focus:bg-blue-600 focus:text-white focus:rounded-md"
        id="parcego-terms-skip-link"
      >
      ...
      <main id="main-content" className="max-w-4xl mx-auto" role="main" aria-label="Terms and Conditions">
          ...
          <Card>
            ...
            <CardContent>
              <ol className="space-y-2 list-decimal list-inside text-sm text-gray-700">
                <li><a href="#parcego-terms-conditions-acceptance" className="hover:text-blue-600 hover:underline focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 rounded">Acceptance of Terms</a></li>
                <li><a href="#parcego-terms-conditions-service-description" className="hover:text-blue-600 hover:underline focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 rounded">Service Description</a></li>
                <li><a href="#parcego-terms-conditions-user-accounts" className="hover:text-blue-600 hover:underline focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 rounded">User Accounts and Registration</a></li>
                <li><a href="#parcego-terms-conditions-acceptable-use" className="hover:text-blue-600 hover:underline focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 rounded">Acceptable Use Policy</a></li>
                <li><a href="#parcego-terms-conditions-payment-terms" className="hover:text-blue-600 hover:underline focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 rounded">Payment Terms and Billing</a></li>
                <li><a href="#parcego-terms-conditions-liability" className="hover:text-blue-600 hover:underline focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 rounded">Limitation of Liability and Disclaimers</a></li>
                <li><a href="#parcego-terms-conditions-insurance" className="hover:text-blue-600 hover:underline focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 rounded">Insurance and Claims</a></li>
                <li><a href="#parcego-terms-conditions-intellectual-property" className="hover:text-blue-600 hover:underline focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 rounded">Intellectual Property Rights</a></li>
                <li><a href="#parcego-terms-conditions-termination" className="hover:text-blue-600 hover:underline focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 rounded">Termination</a></li>
                <li><a href="#parcego-terms-conditions-governing-law" className="hover:text-blue-600 hover:underline focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 rounded">Governing Law and Dispute Resolution</a></li>
                <li><a href="#parcego-terms-conditions-changes" className="hover:text-blue-600 hover:underline focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 rounded">Changes to Terms</a></li>
                <li><a href="#parcego-terms-conditions-contact" className="hover:text-blue-600 hover:underline focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 rounded">Contact Information</a></li>
              </ol>
            </CardContent>
          </Card>
        </nav>
        ...
        <Card id="parcego-terms-conditions-main-content" className="mb-8" role="article" aria-labelledby="terms-overview-title">
          <CardHeader>
          ...
          <CardContent className="space-y-8">
            ...
            {/* Acceptance of Terms */}
            <section id="parcego-terms-conditions-acceptance" aria-labelledby="section-acceptance">
            ...
            {/* Service Description */}
            <section id="parcego-terms-conditions-service-description" aria-labelledby="section-service">
            ...
            {/* User Accounts */}
            <section id="parcego-terms-conditions-user-accounts" aria-labelledby="section-accounts">
            ...
            {/* Acceptable Use */}
            <section id="parcego-terms-conditions-acceptable-use" aria-labelledby="section-use">
            ...
            {/* Payment Terms */}
            <section id="parcego-terms-conditions-payment-terms" aria-labelledby="section-payment">
            ...
            <section id="parcego-terms-conditions-liability" aria-labelledby="section-liability">
            ...
            <section id="parcego-terms-conditions-insurance" aria-labelledby="section-insurance">
            ...
            <section id="parcego-terms-conditions-intellectual-property" aria-labelledby="section-ip">
            ...
            {/* Termination */}
            <section id="parcego-terms-conditions-termination" aria-labelledby="section-termination">
            ...
            {/* Governing Law */}
            <section id="parcego-terms-conditions-governing-law" aria-labelledby="section-law">
            ...
            {/* Changes to Terms */}
            <section id="parcego-terms-conditions-changes" aria-labelledby="section-changes">
            ...
            {/* Contact Information */}
            <section id="parcego-terms-conditions-contact" aria-labelledby="section-contact">
        ...
        <nav aria-label="Related pages" className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button 
            ...
            id="parcego-terms-conditions-privacy-btn"
          ...
          <Button 
            ...
            className="flex items-center gap-2"
            id="parcego-terms-conditions-support-btn"
