                ...
                <TabsContent value="vehicle" className="space-y-4">
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div className="parcego-courier-profile__form-field">
                      ...
                      <select id="type" value={vehicleForm.type} onChange={handleVehicleFieldChange} className="h-9 w-full rounded-md border bg-transparent px-3 text-sm outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50 focus-visible:border-ring">
