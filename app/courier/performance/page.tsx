          ...
          <CardContent>
            <div className="grid grid-cols-3 gap-6 text-sm">
              <div className="p-4 rounded-lg bg-gray-50 text-center">
                ...
                <p className="text-2xl font-bold text-blue-600">{currentData.averageTime} min</p>
              </div>
              <div className="p-4 rounded-lg bg-gray-50 text-center">
                <p className="text-gray-500 mb-2">Distance per Delivery</p>
                <p className="text-2xl font-bold text-purple-600">{Math.round((currentData.distance / Math.max(currentData.deliveries, 1)) * 10) / 10} km</p>
              </div>
              <div className="p-4 rounded-lg bg-gray-50 text-center">
                <p className="text-gray-500 mb-2">On-time Rate</p>
                <p className="text-2xl font-bold text-green-600">{currentData.onTimeRate}%</p>
              </div>
            </div>
          </CardContent>
        </Card>
